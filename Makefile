...
SRC_DIRS += src src/boot src/game src/engine src/audio src/menu src/buffers src/images actors levels bin data assets asm lib sound
...
$(BUILD_DIR)/src/images/crash_screen_crashed_I4.o: $(CRASH_TEXTURE_2_C_FILES)
