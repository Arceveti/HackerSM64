...
#define COURSE_INDEX_TO_NUM(cmd)   ((cmd) + 1)
#define ACT_NUM_TO_INDEX(cmd)      ((cmd) - 1)
#define ACT_INDEX_TO_NUM(cmd)      ((cmd) + 1)
#define SAVE_NUM_TO_INDEX(cmd)     ((cmd) - 1)
#define SAVE_INDEX_TO_NUM(cmd)     ((cmd) + 1)
