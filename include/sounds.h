...
#define SOUND_ACTION_SPIN_UNK39                  /* 0x04398080 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x39, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // same sound as spin, unused
...
#define SOUND_ACTION_FLYING_FAST                 /* 0x04568080 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x56, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_ACTION_TELEPORT                    /* 0x0457C080 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x57, 0xC0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_ACTION_SNUFIT_BULLET_HIT_METAL     /* 0x0458A080 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x58, 0xA0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
...
#define SOUND_ACTION_KEY_PUT_AWAY                /* 0x045C8080 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x5C, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_ACTION_UNK5D                       /* 0x005D0000 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x5D, 0x00, 0) // unverified, unused
#define SOUND_ACTION_INTRO_FLY_OUT_FROM_BRIDGE   /* 0x045E8080 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x5E, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_ACTION_INTRO_FLY_AROUND_PIPE       /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x5F, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
...
#define SOUND_ACTION_TERRAIN_JUMP_UNK68          /* 0x04688080 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x68, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
#define SOUND_MOVING_TERRAIN_RIDING_SHELL_UNK08  /* 0x14080000 */ SOUND_ARG_LOAD(SOUND_BANK_MOVING,   0x08, 0x00, SOUND_NO_PRIORITY_LOSS) // ?, unused
...
#define SOUND_MOVING_COIN_UNK13                  /* 0x18138080 */ SOUND_ARG_LOAD(SOUND_BANK_MOVING ,  0x13, 0x80, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE) // ?, unused
#define SOUND_MOVING_QUICKSAND_DEATH             /* 0x14140000 */ SOUND_ARG_LOAD(SOUND_BANK_MOVING,   0x14, 0x00, SOUND_NO_PRIORITY_LOSS)
#define SOUND_MOVING_COIN_UNK15                  /* 0x18158080 */ SOUND_ARG_LOAD(SOUND_BANK_MOVING,   0x15, 0x80, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE) // ?, unused
...
// 0x1B-0x1F: Last 5 entries of SOUND_MOVING_TERRAIN_SLIDE
...
#define SOUND_MOVING_TERRAIN_RIDING_SHELL_UNK30  /* 0x14300000 */ SOUND_ARG_LOAD(SOUND_BANK_MOVING,   0x30, 0x00, SOUND_NO_PRIORITY_LOSS) // ?, unused
...
#define SOUND_MARIO_COUGHING3_UNK17              /* 0x24178080 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x17, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified, unused
...
#define SOUND_MARIO_UH_UNK25                     /* 0x24258080 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x25, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified, unused
#define SOUND_MARIO_HRMM_UNK26                   /* 0x24268080 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x26, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified, unused
#define SOUND_MARIO_WAH2_UNK27                   /* 0x24278080 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x27, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified, unused
...
#define SOUND_MARIO_JUMP_HOO_UNK29               /* 0x24298080 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x29, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified, unused
#define SOUND_MARIO_JUMP_HOO_UNK2A               /* 0x242A8080 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x2A, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified, unused
...
#define SOUND_GENERAL_ENTER_HOLE_UNK01           /* 0x30018080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x01, 0x80, SOUND_DISCRETE) // unverified, unused
#define SOUND_GENERAL_ENTER_HOLE_UNK02           /* 0x30028080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x02, 0x80, SOUND_DISCRETE) // unverified, unused
...
#define SOUND_GENERAL_COIN_UNK11                 /* 0x30108080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x11, 0x80, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE) // unverified, unused
...
#define SOUND_GENERAL_COIN_WATER_UNK13           /* 0x38138080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x13, 0x80, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE) // unverified, unused
#define SOUND_GENERAL_COIN_WATER_UNK14           /* 0x38148080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x14, 0x80, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE) // unverified, unused
#define SOUND_GENERAL_COIN_WATER_UNK15           /* 0x38158080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x15, 0x80, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE) // unverified, unused
...
#define SOUND_GENERAL_OPEN_CHEST_UNK21           /* 0x31218080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x21, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE) // unverified, unused
...
#define SOUND_GENERAL_OPEN_CHEST_WATER_UNK23     /* 0x31238080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x23, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE) // unverified, unused
#define SOUND_GENERAL_BOX_LANDING_UNK24          /* 0x30240080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x24, 0x00, SOUND_DISCRETE) // unverified, unused
...
#define SOUND_GENERAL_PAINTING_EJECT_UNK29       /* 0x39290080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x29, 0x00, SOUND_NO_VOLUME_LOSS | SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE) // unverified, unused
#define SOUND_GENERAL_PAINTING_EJECT_UNK2A       /* 0x392A0080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x2A, 0x00, SOUND_NO_VOLUME_LOSS | SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE) // unverified, unused
#define SOUND_GENERAL_LEVEL_SELECT_CHANGE        /* 0x302B0080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x2B, 0x00, SOUND_DISCRETE)
#define SOUND_GENERAL_MENU_STAR_SOUND_UNK2C      /* 0x302C0080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x2C, 0x00, SOUND_DISCRETE) // unverified, unused
#define SOUND_GENERAL_PLATFORM                   /* 0x302D8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x2D, 0x80, SOUND_DISCRETE) // unverified
#define SOUND_GENERAL_DONUT_PLATFORM_EXPLOSION   /* 0x302E2080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x2E, 0x20, SOUND_DISCRETE) // used in channel 8
...
#define SOUND_GENERAL_ELEVATOR_WOBBLE            /* 0x303D0080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x3D, 0x00, SOUND_DISCRETE) // unverified
...
#define SOUND_GENERAL_MOVING_PLATFORM_SWITCH     /* 0x303E0080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x3E, 0x00, SOUND_DISCRETE) // used in channel 8
...
#define SOUND_GENERAL_QUIET_POUND1               /* 0x30404080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x40, 0x40, SOUND_DISCRETE) // unverified, used in channel 8
...
#define SOUND_GENERAL_GRINDEL_ROLL               /* 0x30480080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x48, 0x00, SOUND_DISCRETE) // unverified, used in channel 8
...
#define SOUND_GENERAL_PYRAMID_TOP_SPIN           /* 0x314BE080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x4B, 0xE0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE) // unverified, unused here, but used in channel 8
#define SOUND_GENERAL_PYRAMID_TOP_EXPLOSION      /* 0x314CF080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x4C, 0xF0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE) // unverified, unused here, but used in channel 8
...
#define SOUND_GENERAL_BIRD_CHIRP2                /* 0x30504000 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x50, 0x40, 0) // unverified, unused here, but used in channel 8
#define SOUND_GENERAL_BIRD_CHIRP3                /* 0x30514000 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x51, 0x40, 0) // unverified, unused
#define SOUND_GENERAL_BIRD_CHIRP1                /* 0x30524000 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x52, 0x40, 0) // unverified, unused
#define SOUND_GENERAL_CASTLE_OUTDOORS_AMBIENT    /* 0x30534000 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x53, 0x40, 0) // unverified, unused
#define SOUND_GENERAL_SWITCH_TICK_FAST           /* 0x3054F010 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x54, 0xF0, SOUND_LOWER_BACKGROUND_MUSIC) // unverified, unused here, but used in channel 8
#define SOUND_GENERAL_SWITCH_TICK_SLOW           /* 0x3055F010 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x55, 0xF0, SOUND_LOWER_BACKGROUND_MUSIC) // unverified, unused here, but used in channel 8
#define SOUND_GENERAL_POUND_ROCK                 /* 0x30560080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x56, 0x00, SOUND_DISCRETE) // unverified
#define SOUND_GENERAL_STAR_APPEARS               /* 0x3057FF90 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x57, 0xFF, SOUND_LOWER_BACKGROUND_MUSIC | SOUND_DISCRETE) // unverified, used in channel 8
#define SOUND_GENERAL_COLLECT_1UP                /* 0x3058FF80 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x58, 0xFF, SOUND_DISCRETE)
#define SOUND_GENERAL_ROTATING_BLOCK_ALERT       /* 0x30590080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x59, 0x00, SOUND_DISCRETE) // unverified, unused here, but used in channel 8
...
#define SOUND_GENERAL_BOWSER_EXPLODE             /* 0x30600080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x60, 0x00, SOUND_DISCRETE) // unverified, unused here, but used in channel 8
#define SOUND_GENERAL_BOWSER_KEY                 /* 0x30610080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x61, 0x00, SOUND_DISCRETE) // unverified, unused here, but used in channel 8
...
#define SOUND_GENERAL_1UP_APPEAR                 /* 0x3063D080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x63, 0xD0, SOUND_DISCRETE) // unverified, unused here, but used in channel 8
...
#define SOUND_GENERAL_RIGHT_ANSWER               /* 0x306AA080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x6A, 0xA0, SOUND_DISCRETE) // unverified, unused here, but used in channel 8
...
#define SOUND_GENERAL_MONEYBAG_BOING             /* 0x306D2080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x6D, 0x20, SOUND_DISCRETE) // unverified
...
#define SOUND_GENERAL_BOING3_UNK72               /* 0x30720000 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x72, 0x00, 0) // unverified, unused
...
#define SOUND_GENERAL_ENTER_HOLE_UNK77           /* 0x30772080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x77, 0x80, SOUND_DISCRETE) // unverified, unused
#define SOUND_GENERAL_RED_COIN_UNK78             /* 0x30789080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x78, 0x90, SOUND_DISCRETE) // unverified, unused
#define SOUND_GENERAL_BIRDS_FLY_AWAY_UNK79       /* 0x30790080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x79, 0x00, SOUND_DISCRETE) // unverified, unused
#define SOUND_GENERAL_RIGHT_ANSWER_UNK7A         /* 0x307AA080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x7A, 0xA0, SOUND_DISCRETE) // unverified, unused
#define SOUND_GENERAL_ELEVATOR_LAND_UNK7B        /* 0x307B8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x7B, 0x80, SOUND_DISCRETE) // unverified, unused
#define SOUND_GENERAL_CRAZY_BOX_BOING_SLOW_UNK7C /* 0x307C4080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x7C, 0x40, SOUND_DISCRETE) // unverified, unused
#define SOUND_GENERAL_MONEYBAG_BOING_UNK7D       /* 0x307D2080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x7D, 0x20, SOUND_DISCRETE) // unverified, unused
#define SOUND_GENERAL_CRAZY_BOX_BOING_FAST_UNK7D /* 0x307D4080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x7D, 0x40, SOUND_DISCRETE) // unverified, unused
#define SOUND_GENERAL_YOSHI_WALK_UNK7E           /* 0x307E2080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x7E, 0x20, SOUND_DISCRETE) // unverified, unused
#define SOUND_GENERAL_ENEMY_ALERT1_UNK7F         /* 0x307F3080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x7F, 0x30, SOUND_DISCRETE) // unverified, unused

/* Environment Sound Effects */
#define SOUND_ENV_WATERFALL1                     /* 0x40000000 */ SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x00, 0x00, 0) // unverified
#define SOUND_ENV_WATERFALL2                     /* 0x40010000 */ SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x01, 0x00, 0) // unverified, same sound as above
...
#define SOUND_ENV_ROUGH_SLIDE                    /* 0x40110000 */ SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x11, 0x00, 0) // unverified, unused
...
#define SOUND_ENV_PEACH_TWINKLE                  /* 0x40194000 */ SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x19, 0x40, 0) // unverified, unused
#define SOUND_ENV_ELEVATOR1_UNK1A                /* 0x401A0000 */ SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x1A, 0x00, 0) // unverified, unused
#define SOUND_ENV_DRONING1_UNK1B                 /* 0x401B0000 */ SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x1B, 0x00, 0) // unverified, unused
#define SOUND_ENV_WATERFALL1_UNK1C               /* 0x401C0000 */ SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x1C, 0x00, 0) // unverified, unused
#define SOUND_ENV_WATERFALL1_UNK1D               /* 0x401D0000 */ SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x1D, 0x00, 0) // unverified, unused
#define SOUND_ENV_WATERFALL1_UNK1E               /* 0x401E0000 */ SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x1E, 0x00, 0) // unverified, unused
#define SOUND_ENV_WATERFALL1_UNK1F               /* 0x401F0000 */ SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x1F, 0x00, 0) // unverified, unused
#define SOUND_ENV_ENTER_HOLE                     /* 0x41208080 */ SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x20, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE) // unverified, unused
#define SOUND_ENV_ELEVATOR_MOVE_UNK21            /* 0x41210080 */ SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x21, 0x00, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE) // unverified
#define SOUND_ENV_ELEVATOR1_UNK22                /* 0x40220000 */ SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x22, 0x00, 0) // unverified, unused
#define SOUND_ENV_DRONING1_UNK23                 /* 0x40230000 */ SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x23, 0x00, 0) // unverified, unused
#define SOUND_ENV_WATERFALL1_UNK24               /* 0x40240000 */ SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x24, 0x00, 0) // unverified, unused
#define SOUND_ENV_WATERFALL1_UNK25               /* 0x40250000 */ SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x25, 0x00, 0) // unverified, unused
#define SOUND_ENV_WATERFALL1_UNK26               /* 0x40260000 */ SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x26, 0x00, 0) // unverified, unused
#define SOUND_ENV_WATERFALL1_UNK27               /* 0x40270000 */ SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x27, 0x00, 0) // unverified, unused
...
#define SOUND_OBJ_BOWSER_ROAR                    /* 0x50040080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x04, 0x00, SOUND_DISCRETE) // unverified, unused here, but used in channel 9
...
#define SOUND_OBJ_PIRANHA_PLANT_BITE             /* 0x50105080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x10, 0x50, SOUND_DISCRETE) // unverified, unused here, but used in channel 9
#define SOUND_OBJ_PIRANHA_PLANT_DYING            /* 0x50116080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x11, 0x60, SOUND_DISCRETE) // unverified, unused here, but used in channel 9
...
#define SOUND_OBJ_KING_BOBOMB_POUNDING           /* 0x50158080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x15, 0x80, SOUND_DISCRETE) // unverified
...
#define SOUND_OBJ_BOWSER_PUZZLE_PIECE_MOVE       /* 0x50192080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x19, 0x20, SOUND_DISCRETE) // unverified, unused here, but used in channel 9
...
#define SOUND_OBJ_SMALL_BULLY_ATTACKED           /* 0x501C0080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x1C, 0x00, SOUND_DISCRETE) // unverified, unused here, but used in channel 9
...
#define SOUND_OBJ_KING_BOBOMB_DAMAGE             /* 0x51424080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x42, 0x40, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE) // unverified, unused here, but used in channel 9
#define SOUND_OBJ_SCUTTLEBUG_WALK                /* 0x50434080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x43, 0x40, SOUND_DISCRETE) // unverified, unused here, but used in channel 9
#define SOUND_OBJ_SCUTTLEBUG_ALERT               /* 0x50444080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x44, 0x40, SOUND_DISCRETE) // unverified, unused here, but used in channel 9
#define SOUND_OBJ_BABY_PENGUIN_YELL              /* 0x50450080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x45, 0x00, SOUND_DISCRETE) // unverified, unused here, but used in channel 9
...
#define SOUND_OBJ_SWOOP_WAKE_UP                  /* 0x50490080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x49, 0x00, SOUND_DISCRETE) // unverified, unused here, but used in channel 9
...
#define SOUND_OBJ_BIRD_CHIRP2                    /* 0x50504000 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x50, 0x40, 0) // unverified, unused
#define SOUND_OBJ_BIRD_CHIRP3                    /* 0x50514000 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x51, 0x40, 0)
#define SOUND_OBJ_BIRD_CHIRP1                    /* 0x50524000 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x52, 0x40, 0) // unverified, unused here, but used in channel 9
#define SOUND_OBJ_CASTLE_OUTDOORS_AMBIENT        /* 0x50104000 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x53, 0x40, 0) // unverified, unused
...
#define SOUND_OBJ_LARGE_BULLY_ATTACKED           /* 0x50570080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x57, 0x00, SOUND_DISCRETE) // unverified, unused here, but used in channel 9
...
#define SOUND_OBJ_EYEROK_SOUND_SHORT             /* 0x535A0080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x5A, 0x00, SOUND_NO_VOLUME_LOSS | SOUND_VIBRATO | SOUND_DISCRETE) // unverified, unused here, but used in channel 9
#define SOUND_OBJ_WHOMP_SOUND_SHORT              /* 0x535AC080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x5A, 0xC0, SOUND_NO_VOLUME_LOSS | SOUND_VIBRATO | SOUND_DISCRETE) // unverified, unused here, but used in channel 9
#define SOUND_OBJ_EYEROK_SOUND_LONG              /* 0x525B0080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x5B, 0x00, SOUND_VIBRATO | SOUND_DISCRETE) // unverified, unused here, but used in channel 9
...
#define SOUND_OBJ_BOWSER_TELEPORT                /* 0x50668080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x66, 0x80, SOUND_DISCRETE) // unverified, unused here, but used in channel 9
#define SOUND_OBJ_MONTY_MOLE_APPEAR              /* 0x50678080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x67, 0x80, SOUND_DISCRETE) // unverified, unused here, but used in channel 9
#define SOUND_OBJ_POUNDING_LOUD                  /* 0x50684080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x68, 0x40, SOUND_DISCRETE) // unverified
#define SOUND_OBJ_BOSS_DIALOG_GRUNT              /* 0x50694080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x69, 0x40, SOUND_DISCRETE) // unverified, unused here, but used in channel 9
#define SOUND_OBJ_MIPS_RABBIT                    /* 0x506A0080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x6A, 0x00, SOUND_DISCRETE) // unverified
#define SOUND_OBJ_MRI_SPINNING                   /* 0x506B0080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x6B, 0x00, SOUND_DISCRETE) // unverified, unused here, but used in channel 9
...
#define SOUND_OBJ_BOWSER_TAIL_PICKUP_UNK75       /* 0x50750080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x75, 0x00, SOUND_DISCRETE) // unverified, unused
#define SOUND_OBJ_BOWSER_DEFEATED_UNK76          /* 0x50760080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x76, 0x00, SOUND_DISCRETE) // unverified, unused
#define SOUND_OBJ_BOWSER_SPINNING_UNK77          /* 0x50770080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x77, 0x00, SOUND_DISCRETE) // unverified, unused
#define SOUND_OBJ_KLEPTO_ATTACKED_UNK78          /* 0x50786080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x78, 0x60, SOUND_DISCRETE) // unverified, unused
#define SOUND_OBJ_KING_BOBOMB_TALK_UNK79         /* 0x50790080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x79, 0x00, SOUND_DISCRETE) // unverified, unused
#define SOUND_OBJ_BABY_PENGUIN_WALK_UNK7A        /* 0x507A0080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x7A, 0x00, SOUND_DISCRETE) // unverified, unused
#define SOUND_OBJ_BOWSER_WALK_UNK7B              /* 0x507B0080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x7B, 0x00, SOUND_DISCRETE) // unverified, unused
#define SOUND_OBJ_BOWSER_ROAR_UNK7C              /* 0x507C0080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x7C, 0x00, SOUND_DISCRETE) // unverified, unused
#define SOUND_OBJ_BOWSER_TAIL_PICKUP_UNK7D       /* 0x507D0080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x7D, 0x00, SOUND_DISCRETE) // unverified, unused
#define SOUND_OBJ_BOWSER_DEFEATED_UNK7E          /* 0x507E0080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x7E, 0x00, SOUND_DISCRETE) // unverified, unused
#define SOUND_OBJ_BOWSER_SPINNING_UNK7F          /* 0x507F0080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x7F, 0x00, SOUND_DISCRETE) // unverified, unused
...
#define SOUND_AIR_BOWSER_SPIT_FIRE_UNK0C         /* 0x600C0000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x0C, 0x00, 0) // ?, unused
#define SOUND_AIR_BOWSER_SPIT_FIRE_UNK0D         /* 0x600D0000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x0D, 0x00, 0) // ?, unused
#define SOUND_AIR_BOWSER_SPIT_FIRE_UNK0E         /* 0x600E0000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x0E, 0x00, 0) // ?, unused
#define SOUND_AIR_BOWSER_SPIT_FIRE_UNK0F         /* 0x600F0000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x0F, 0x00, 0) // ?, unused
#define SOUND_AIR_CASTLE_OUTDOORS_AMBIENT        /* 0x60104000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x10, 0x40, 0)
#define SOUND_AIR_UNK11                          /* 0x60110000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x11, 0x00, 0) // ?, unused
#define SOUND_AIR_BOWSER_SPIT_FIRE_UNK12         /* 0x60120000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x12, 0x00, 0) // ?, unused
#define SOUND_AIR_BOWSER_SPIT_FIRE_UNK13         /* 0x60130000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x13, 0x00, 0) // ?, unused
#define SOUND_AIR_BOWSER_SPIT_FIRE_UNK14         /* 0x60140000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x14, 0x00, 0) // ?, unused
#define SOUND_AIR_BOWSER_SPIT_FIRE_UNK15         /* 0x60150000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x15, 0x00, 0) // ?, unused
#define SOUND_AIR_BOWSER_SPIT_FIRE_UNK16         /* 0x60160000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x16, 0x00, 0) // ?, unused
#define SOUND_AIR_BOWSER_SPIT_FIRE_UNK17         /* 0x60170000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x17, 0x00, 0) // ?, unused
#define SOUND_AIR_BOWSER_SPIT_FIRE_UNK18         /* 0x60180000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x18, 0x00, 0) // ?, unused
#define SOUND_AIR_UNK19                          /* 0x60190000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x19, 0x00, 0) // ?, unused
#define SOUND_AIR_BOWSER_SPIT_FIRE_UNK1A         /* 0x601A0000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x1A, 0x00, 0) // ?, unused
#define SOUND_AIR_BOWSER_SPIT_FIRE_UNK1B         /* 0x601B0000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x1B, 0x00, 0) // ?, unused
#define SOUND_AIR_BOWSER_SPIT_FIRE_UNK1C         /* 0x601C0000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x1C, 0x00, 0) // ?, unused
#define SOUND_AIR_BOWSER_SPIT_FIRE_UNK1D         /* 0x601D0000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x1D, 0x00, 0) // ?, unused
#define SOUND_AIR_BOWSER_SPIT_FIRE_UNK1E         /* 0x601E0000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x1E, 0x00, 0) // ?, unused
#define SOUND_AIR_BOWSER_SPIT_FIRE_UNK1F         /* 0x601F0000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x1F, 0x00, 0) // ?, unused
...
#define SOUND_MENU_READ_SIGN                     /* 0x70120000 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x12, 0x00, 0) // unverified, unused
...
#define SOUND_MENU_YOSHI_GAIN_LIVES_UNK25        /* 0x70250080 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x25, 0x00, SOUND_DISCRETE) // unverified, unused
#define SOUND_MENU_ENTER_PIPE_UNK26              /* 0x7026A080 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x26, 0xA0, SOUND_DISCRETE) // unverified, unused
#define SOUND_MENU_EXIT_PIPE_UNK27               /* 0x7027A080 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x27, 0xA0, SOUND_DISCRETE) // unverified, unused
...
#define SOUND_MENU_PINCH_MARIO_FACE_UNK38        /* 0x70380080 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x38, 0x00, SOUND_DISCRETE) // unverified, unused
#define SOUND_MENU_LET_GO_MARIO_FACE_UNK39       /* 0x70390080 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x39, 0x00, SOUND_DISCRETE) // unverified, unused
#define SOUND_MENU_HAND_APPEAR_UNK3A             /* 0x703A0080 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x3A, 0x00, SOUND_DISCRETE) // unverified, unused
#define SOUND_MENU_HAND_DISAPPEAR_UNK3B          /* 0x703B0080 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x3B, 0x00, SOUND_DISCRETE) // unverified, unused
#define SOUND_MENU_UNK3C_FLAG_UNKNOWN1           /* 0x703C0080 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x3C, 0x00, SOUND_DISCRETE) // unverified, unused
#define SOUND_MENU_POWER_METER_UNK3D             /* 0x703D0080 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x3D, 0x00, SOUND_DISCRETE) // unverified, unused
#define SOUND_MENU_CAMERA_BUZZ_UNK3E             /* 0x703E0080 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x3E, 0x00, SOUND_DISCRETE) // unverified, unused
#define SOUND_MENU_CAMERA_TURN_UNK3F             /* 0x703F0080 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x3F, 0x00, SOUND_DISCRETE) // unverified, unused
