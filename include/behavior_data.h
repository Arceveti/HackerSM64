...
enum BehaviorCommands {
    ...
    /*0x0F*/ BHV_CMD_ADD_SHORT,
    /*0x10*/ BHV_CMD_SET_SHORT,
    /*0x11*/ BHV_CMD_OR_SHORT,
    ...
    /*0x18*/ BHV_CMD_ADD_INT,
    /*0x19*/ BHV_CMD_SET_INT,
    /*0x1A*/ BHV_CMD_OR_INT,
...
extern const BehaviorScript bhvBitfsSinkingCagePole[];
...
extern const BehaviorScript bhvBowserSkyFlameGroupRising[];
extern const BehaviorScript bhvBowserSkyFlameGroupFalling[];
...
extern const BehaviorScript bhvJrbFloatingShipVisual[];
extern const BehaviorScript bhvJrbFloatingShipCollision[];
extern const BehaviorScript bhvSunkenShipPart2[];
extern const BehaviorScript bhvJrbSunkenShipCollision[];
extern const BehaviorScript bhvJrbSunkenShipCollision2[];
