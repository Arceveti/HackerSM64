...
// optionally OR'd with SEQ_FLAG_VARIATION.
#define SEQ_MASK_ID         BITMASK(7)
#define SEQ_FLAG_VARIATION  BIT(7)
#define SEQUENCE_NONE       BITMASK(8)

#define SEQ_MENU_GAME_OVER (SEQ_MENU_TITLE_SCREEN | SEQ_FLAG_VARIATION)
...
enum SeqSettingsPresets {
    SEQ_SETTINGS_PRESET_DEFAULT,
    SEQ_SETTINGS_PRESET_CASTLE,
    SEQ_SETTINGS_PRESET_BOSS,
    SEQ_SETTINGS_PRESET_WATER,
    SEQ_SETTINGS_PRESET_CAVE,
    SEQ_SETTINGS_PRESET_WF,
    SEQ_SETTINGS_PRESET_6,
    SEQ_SETTINGS_PRESET_CREDITS,
    SEQ_SETTINGS_PRESET_COUNT
};
