...
- **Arceveti**: New crash screen, silhouette, various optimizations including shadows, breath meter, painting objects, star glow, z offset geo command, 4 controller support, major input refactoring, controller reassignment, controller icons, alternate rumble graphics, implementation of better wall collision, better hanging, naming most unknowns, various hacker QOL improvements, and various optimizations/fixes
