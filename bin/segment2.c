...
static const u8 small_font_kerning_outline[] = {
    /*!*/ 2, /*"*/ 4, /*#*/ 0, /*$*/ 0, /*%*/ 6, /*&*/ 6, /*'*/ 2, /*(*/ 4, /*)*/ 4, /***/ 0, /*+*/ 6, /*,*/ 2, /*-*/ 6, /*.*/ 2, /*/*/ 6, /*0*/ 6,
...
const struct PPTextFont sPPFont_default = {
    .tex    = small_font_default,
    .kern   = small_font_kerning_default,
    .offset = small_font_offsets_default,
    .pal    = NULL,
    .fmt    = G_IM_FMT_I,
    .siz    = G_IM_SIZ_4b,
    .imW    = FONT_IMG_WIDTH,
    .imH    = FONT_IMG_HEIGHT,
    .txW    = FONT_CHAR_SPACING_WIDTH,
    .txH    = FONT_CHAR_SPACING_HEIGHT,
};

const struct PPTextFont sPPFont_outline = {
    .tex    = small_font_outline,
    .kern   = small_font_kerning_outline,
    .offset = small_font_offsets_outline,
    .pal    = NULL,
    .fmt    = G_IM_FMT_IA,
    .siz    = G_IM_SIZ_4b,
    .imW    = FONT_IMG_WIDTH,
...
const struct PPTextFont sPPFont_plain = {
    .tex    = small_font_plain,
    .kern   = small_font_kerning_plain,
    .offset = small_font_offsets_plain,
    .pal    = NULL,
    .fmt    = G_IM_FMT_I,
    .siz    = G_IM_SIZ_4b,
    .imW    = FONT_IMG_WIDTH,
...
const struct PPTextFont sPPFont_vanilla = {
    .tex    = small_font_vanilla,
    .kern   = small_font_kerning_vanilla,
    .offset = small_font_offsets_vanilla,
    .pal    = NULL,
    .fmt    = G_IM_FMT_I,
    .siz    = G_IM_SIZ_4b,
    .imW    = FONT_IMG_WIDTH,
...
#if STAR_GLOW
ALIGNED8 const Texture texture_radial_light[] = {
...
const Vtx vertex_star_glow[] = {
    {{{ -STAR_GLOW, -STAR_GLOW,      0}, 0, {     0,   2032}, 0xFF, 0xF0, 0x00, 0xFF}},
    {{{  STAR_GLOW, -STAR_GLOW,      0}, 0, {  2032,   2032}, 0xFF, 0xF0, 0x00, 0xFF}},
    {{{  STAR_GLOW,  STAR_GLOW,      0}, 0, {  2032,      0}, 0xFF, 0xF0, 0x00, 0xFF}},
    {{{ -STAR_GLOW,  STAR_GLOW,      0}, 0, {     0,      0}, 0xFF, 0xF0, 0x00, 0xFF}},
};

// 0x0302C300 - 0x0302C
const Gfx dl_star_glow[] = {
    gsDPPipeSync(),
...
const PaintingData painting_data_triangles[] = {
    264, // num triangles
