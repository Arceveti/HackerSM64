...
/* 0x02015444: painting_data_mesh_neighbor_tris
...
const PaintingData *const painting_data_triangles_1_array[] = {
    painting_data_triangles_1,
};
...
// 0x07022518
const PaintingData *const painting_data_triangles_2_array[] = {
    painting_data_triangles_2_bottom,
    painting_data_triangles_2_top,
};
