...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		WARP_NODE(0xF3, LEVEL_JRB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -28, 700, -21563, 0, 0, 0, (10 << 24) | (DLG_BLACK_HOLE << 16), bhvDLG),
		MARIO_POS(0x01, 0, -28, 1300, -21563),
		OBJECT(MODEL_BLACK_HOLE, -28, -100, 12837, 0, 0, 0, 0x00000000, bhvBlackHole),
		OBJECT(MODEL_NONE, -28, 1300, -21563, 0, 0, 0, (0x0A << 16), bhvAirborneWarp),
