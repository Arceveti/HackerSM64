...
const LevelScript level_ttm_entry[] = {
    ...
    AREA(/*index*/ 1, ttm_geo_000A70),
        OBJECT(/*model*/ MODEL_NONE,     /*pos*/   102, -3332,  5734, /*angle*/ 0,   45, 0, /*behParam*/ WARP_TTM_1_MAIN_ENTRY << 16, /*beh*/ bhvSpinAirborneWarp),
        OBJECT(/*model*/ MODEL_NONE,     /*pos*/ -2447, -2457,  3952, /*angle*/ 0, -105, 0, /*behParam*/ WARP_TTM_1_FROM_TTM_4 << 16, /*beh*/ bhvAirborneWarp),
        OBJECT(/*model*/ MODEL_NONE,     /*pos*/  2267, -3006, -3788, /*angle*/ 0,  148, 0, /*behParam*/ WARP_TTM_1_FADING_A   << 16, /*beh*/ bhvFadingWarp),
        OBJECT(/*model*/ MODEL_NONE,     /*pos*/  -557, -3448, -4146, /*angle*/ 0, -168, 0, /*behParam*/ WARP_TTM_1_FADING_B   << 16, /*beh*/ bhvFadingWarp),
        WARP_NODE(/*id*/ WARP_TTM_1_MAIN_ENTRY, /*destLevel*/ LEVEL_TTM,    /*destArea*/ 0x01, /*destNode*/ WARP_TTM_1_MAIN_ENTRY,                 /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_TTM_1_FROM_TTM_4, /*destLevel*/ LEVEL_TTM,    /*destArea*/ 0x01, /*destNode*/ WARP_TTM_1_FROM_TTM_4,                 /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_TTM_1_FADING_A,   /*destLevel*/ LEVEL_TTM,    /*destArea*/ 0x01, /*destNode*/ WARP_TTM_1_FADING_B,                   /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_TTM_1_FADING_B,   /*destLevel*/ LEVEL_TTM,    /*destArea*/ 0x01, /*destNode*/ WARP_TTM_1_FADING_A,                   /*flags*/ WARP_NO_CHECKPOINT),
        OBJECT(/*model*/ MODEL_PAINTING, /*pos*/  3072,   922,  -819, /*angle*/ 0,   90, 0, /*behParam*/ PAINTING_ID(PAINTING_ID_TTM_SLIDE, PAINTING_GROUP_TTM) << 16, /*beh*/ bhvPainting),
        PAINTING_WARP_NODE(/*id*/ PAINTING_ID_TTM_SLIDE, /*destLevel*/ LEVEL_TTM, /*destArea*/ 0x02, /*destNode*/ WARP_TTM_2_MAIN_ENTRY, /*flags*/ WARP_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEFAULT,     /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x02, /*destNode*/ WARP_CASTLE_INSIDE_2_FROM_TTM_SUCCESS, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEATH,       /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x02, /*destNode*/ WARP_CASTLE_INSIDE_2_FROM_TTM_DEATH,   /*flags*/ WARP_NO_CHECKPOINT),
    ...
    AREA(/*index*/ 2, ttm_geo_000B5C),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ 7000, 5381, 6750, /*angle*/ 0, 225, 0, /*behParam*/ WARP_TTM_2_MAIN_ENTRY << 16, /*beh*/ bhvAirborneWarp),
        WARP_NODE(/*id*/ WARP_TTM_2_MAIN_ENTRY, /*destLevel*/ LEVEL_TTM,    /*destArea*/ 0x02, /*destNode*/ WARP_TTM_2_MAIN_ENTRY,                 /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEFAULT,     /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x02, /*destNode*/ WARP_CASTLE_INSIDE_2_FROM_TTM_SUCCESS, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEATH,       /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x02, /*destNode*/ WARP_CASTLE_INSIDE_2_FROM_TTM_DEATH,   /*flags*/ WARP_NO_CHECKPOINT),
    ...
    AREA(/*index*/ 4, ttm_geo_000C84),
        OBJECT(/*model*/ MODEL_TTM_SLIDE_EXIT_PODIUM, /*pos*/ -7285, -1866, -4812, /*angle*/ 0, 0, 0, /*behParam*/ WARP_TTM_4_MAIN_ENTRY << 16, /*beh*/ bhvExitPodiumWarp),
        WARP_NODE(/*id*/ WARP_TTM_4_MAIN_ENTRY, /*destLevel*/ LEVEL_TTM,    /*destArea*/ 0x01, /*destNode*/ WARP_TTM_1_FROM_TTM_4,                 /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEFAULT,     /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x02, /*destNode*/ WARP_CASTLE_INSIDE_2_FROM_TTM_SUCCESS, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEATH,       /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x02, /*destNode*/ WARP_CASTLE_INSIDE_2_FROM_TTM_DEATH,   /*flags*/ WARP_NO_CHECKPOINT),
