...
const LevelScript level_ttm_entry[] = {
    ...
    AREA(/*index*/ 1, ttm_geo_000A70),
        ...
        OBJECT(/*model*/ MODEL_PAINTING, /*pos*/  3072,   922,  -819, /*angle*/ 0,   90, 0, /*behParam*/ ((PAINTING_ID_TTM_SLIDE << 24) | (WARP_TTM_1_PAINTING_SLIDE << 16)), /*beh*/ bhvPainting),
        WARP_NODE(/*id*/ WARP_TTM_1_PAINTING_SLIDE, /*destLevel*/ LEVEL_TTM,    /*destArea*/ 0x02, /*destNode*/ WARP_TTM_2_MAIN_ENTRY, /*flags*/ WARP_CHECKPOINT),
