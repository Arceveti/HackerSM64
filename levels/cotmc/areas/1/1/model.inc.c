...
static const Gfx cotmc_seg7_dl_070066E8[] = {
    ...
    gsSPLightColor(LIGHT_1, 0x96f0e1ff),
    gsSPLightColor(LIGHT_2, 0x4b7870ff),
    ...
    gsSPLightColor(LIGHT_1, 0x7878ff),
    gsSPLightColor(LIGHT_2, 0x3c3cff),
...
static const Gfx cotmc_seg7_dl_07006C18[] = {
    ...
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLightColor(LIGHT_1, 0x777777ff),
