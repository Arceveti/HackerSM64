...
const LevelScript level_ccm_entry[] = {
    ...
    AREA(/*index*/ 1, ccm_geo_00051C),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -1512,  3560, -2305, /*angle*/ 0,  140, 0, /*behParam*/              WARP_CCM_1_MAIN_ENTRY << 16, /*beh*/ bhvSpinAirborneWarp),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/  -181,  2918, -1486, /*angle*/ 0,    0, 0, /*behParam*/ (15 << 24) | WARP_CCM_1_TO_CCM_2   << 16, /*beh*/ bhvWarp),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -1847,  2815,  -321, /*angle*/ 0, -158, 0, /*behParam*/              WARP_CCM_1_FADING_A   << 16, /*beh*/ bhvFadingWarp),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/  3349, -4694,  -183, /*angle*/ 0,  -34, 0, /*behParam*/              WARP_CCM_1_FADING_B   << 16, /*beh*/ bhvFadingWarp),
        WARP_NODE(/*id*/ WARP_CCM_1_MAIN_ENTRY, /*destLevel*/ LEVEL_CCM,    /*destArea*/ 0x01, /*destNode*/ WARP_CCM_1_MAIN_ENTRY,                 /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_CCM_1_FROM_CCM_2, /*destLevel*/ LEVEL_CCM,    /*destArea*/ 0x02, /*destNode*/ WARP_CCM_2_FROM_CCM_1,                 /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_CCM_1_TO_CCM_2,   /*destLevel*/ LEVEL_CCM,    /*destArea*/ 0x02, /*destNode*/ WARP_CCM_2_MAIN_ENTRY,                 /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_CCM_1_FADING_A,   /*destLevel*/ LEVEL_CCM,    /*destArea*/ 0x01, /*destNode*/ WARP_CCM_1_FADING_B,                   /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_CCM_1_FADING_B,   /*destLevel*/ LEVEL_CCM,    /*destArea*/ 0x01, /*destNode*/ WARP_CCM_1_FADING_A,                   /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEFAULT,     /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x01, /*destNode*/ WARP_CASTLE_INSIDE_1_FROM_CCM_SUCCESS, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEATH,       /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x01, /*destNode*/ WARP_CASTLE_INSIDE_1_FROM_CCM_DEATH,   /*flags*/ WARP_NO_CHECKPOINT),
    ...
    AREA(/*index*/ 2, ccm_geo_0005E8),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -5836, 7465, -6143, /*angle*/ 0, 90, 0, /*behParam*/ WARP_CCM_2_MAIN_ENTRY << 16, /*beh*/ bhvAirborneWarp),
        WARP_NODE(/*id*/ WARP_CCM_2_FROM_CCM_1, /*destLevel*/ LEVEL_CCM,    /*destArea*/ 0x01, /*destNode*/ WARP_CCM_1_FROM_CCM_2,                 /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_CCM_2_MAIN_ENTRY, /*destLevel*/ LEVEL_CCM,    /*destArea*/ 0x02, /*destNode*/ WARP_CCM_2_MAIN_ENTRY,                 /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEFAULT,     /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x01, /*destNode*/ WARP_CASTLE_INSIDE_1_FROM_CCM_SUCCESS, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEATH,       /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x01, /*destNode*/ WARP_CASTLE_INSIDE_1_FROM_CCM_DEATH,   /*flags*/ WARP_NO_CHECKPOINT),
