...
const LevelScript level_lll_entry[] = {
    ...
    AREA(/*index*/ 1, lll_geo_000E00),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -3839, 1154, 6272, /*angle*/ 0,   90, 0, /*behParam*/              WARP_LLL_1_MAIN_ENTRY << 16, /*beh*/ bhvSpinAirborneWarp),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/     0,  105,    0, /*angle*/ 0,    0, 0, /*behParam*/ (25 << 24) | WARP_LLL_1_TO_LLL_2   << 16, /*beh*/ bhvWarp),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -3200,   11, 3456, /*angle*/ 0, -100, 0, /*behParam*/              WARP_LLL_1_FADING_A   << 16, /*beh*/ bhvFadingWarp),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -5888,  154, 6656, /*angle*/ 0,  100, 0, /*behParam*/              WARP_LLL_1_FADING_B   << 16, /*beh*/ bhvFadingWarp),
        WARP_NODE(/*id*/ WARP_LLL_1_MAIN_ENTRY, /*destLevel*/ LEVEL_LLL,    /*destArea*/ 0x01, /*destNode*/ WARP_LLL_1_MAIN_ENTRY,                 /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_LLL_1_TO_LLL_2,   /*destLevel*/ LEVEL_LLL,    /*destArea*/ 0x02, /*destNode*/ WARP_LLL_2_MAIN_ENTRY,                 /*flags*/ WARP_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_LLL_1_FADING_A,   /*destLevel*/ LEVEL_LLL,    /*destArea*/ 0x01, /*destNode*/ WARP_LLL_1_FADING_B,                   /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_LLL_1_FADING_B,   /*destLevel*/ LEVEL_LLL,    /*destArea*/ 0x01, /*destNode*/ WARP_LLL_1_FADING_A,                   /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEFAULT,     /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x03, /*destNode*/ WARP_CASTLE_INSIDE_3_FROM_LLL_SUCCESS, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEATH,       /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x03, /*destNode*/ WARP_CASTLE_INSIDE_3_FROM_LLL_DEATH,   /*flags*/ WARP_NO_CHECKPOINT),
    ...
    AREA(/*index*/ 2, lll_geo_000EC0),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -955, 1103, -1029, /*angle*/ 0, 118, 0, /*behParam*/ WARP_LLL_2_MAIN_ENTRY << 16, /*beh*/ bhvAirborneWarp),
        WARP_NODE(/*id*/ WARP_LLL_2_MAIN_ENTRY, /*destLevel*/ LEVEL_LLL,    /*destArea*/ 0x02, /*destNode*/ WARP_LLL_2_MAIN_ENTRY,                 /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEFAULT,     /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x03, /*destNode*/ WARP_CASTLE_INSIDE_3_FROM_LLL_SUCCESS, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEATH,       /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x03, /*destNode*/ WARP_CASTLE_INSIDE_3_FROM_LLL_DEATH,   /*flags*/ WARP_NO_CHECKPOINT),
