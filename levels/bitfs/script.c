...
const LevelScript level_bitfs_entry[] = {
    ...
    AREA(/*index*/ 1, bitfs_geo_0007A0),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -7577, -1764,  0, /*angle*/ 0, 90, 0, /*behParam*/              WARP_BITFS_MAIN_ENTRY          << 16, /*beh*/ bhvAirborneWarp),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/  6735,  3681, 99, /*angle*/ 0,  0, 0, /*behParam*/ (20 << 24) | WARP_BITFS_TO_BOWSER_2         << 16, /*beh*/ bhvWarp),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/  5886,  5000, 99, /*angle*/ 0, 90, 0, /*behParam*/              WARP_BITFS_FROM_BOWSER_2_DEATH << 16, /*beh*/ bhvDeathWarp),
        WARP_NODE(/*id*/ WARP_BITFS_MAIN_ENTRY,          /*destLevel*/ LEVEL_BITFS,    /*destArea*/ 0x01, /*destNode*/ WARP_BITFS_MAIN_ENTRY,                 /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_BITFS_TO_BOWSER_2,         /*destLevel*/ LEVEL_BOWSER_2, /*destArea*/ 0x01, /*destNode*/ WARP_BOWSER_2_MAIN_ENTRY,              /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_BITFS_FROM_BOWSER_2_DEATH, /*destLevel*/ LEVEL_BITFS,    /*destArea*/ 0x01, /*destNode*/ WARP_BITFS_FROM_BOWSER_2_DEATH,        /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEATH,                /*destLevel*/ LEVEL_CASTLE,   /*destArea*/ 0x03, /*destNode*/ WARP_CASTLE_INSIDE_3_FROM_BITFS_DEATH, /*flags*/ WARP_NO_CHECKPOINT),
