...
#ifndef WF_BREAKABLE_WALL_SPAWNS_STAR
...
const LevelScript level_wf_entry[] = {
    ...
    AREA(/*index*/ 1, wf_geo_000BF8),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/  2600, 1256,  5120, /*angle*/ 0, 90, 0, /*behParam*/ WARP_WF_MAIN_ENTRY << 16, /*beh*/ bhvSpinAirborneWarp),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -2925, 2560,  -947, /*angle*/ 0, 19, 0, /*behParam*/ WARP_WF_FADING_A   << 16, /*beh*/ bhvFadingWarp),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/  2548, 1075, -3962, /*angle*/ 0, 51, 0, /*behParam*/ WARP_WF_FADING_B   << 16, /*beh*/ bhvFadingWarp),
        WARP_NODE(/*id*/ WARP_WF_MAIN_ENTRY, /*destLevel*/ LEVEL_WF,     /*destArea*/ 0x01, /*destNode*/ WARP_WF_MAIN_ENTRY,                   /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_WF_FADING_A,   /*destLevel*/ LEVEL_WF,     /*destArea*/ 0x01, /*destNode*/ WARP_WF_FADING_B,                     /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_WF_FADING_B,   /*destLevel*/ LEVEL_WF,     /*destArea*/ 0x01, /*destNode*/ WARP_WF_FADING_A,                     /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEFAULT,  /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x01, /*destNode*/ WARP_CASTLE_INSIDE_1_FROM_WF_SUCCESS, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEATH,    /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x01, /*destNode*/ WARP_CASTLE_INSIDE_1_FROM_WF_DEATH,   /*flags*/ WARP_NO_CHECKPOINT),
        ...
        SET_BACKGROUND_MUSIC(/*settingsPreset*/ SEQ_SETTINGS_PRESET_WF, /*seq*/ SEQ_LEVEL_GRASS),
