...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, 0, -5297, 10039, 0, 0, 0, (10 << 24) | (DLG_UPHILL << 16), bhvDLG),
		MARIO_POS(0x01, 0, 0, -5000, 10000),
		OBJECT(MODEL_SHIELD, 0, 0, 0, 0, 0, 0, 0x00000000, bhvShield),
		OBJECT(MODEL_NONE, 0, -5000, 10000, 0, 0, 0, (0x0A << 16), bhvAirborneWarp),
		OBJECT(MODEL_NONE, 0, -5600, 0, 0, 0, 0, (80 << 24) | (0x0B << 16), bhvWarp),
