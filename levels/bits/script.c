...
const LevelScript level_bits_entry[] = {
    ...
    AREA(/*index*/ 1, bits_geo_000718),
        OBJECT(/*model*/ MODEL_NONE,           /*pos*/ -7039, -3812,     4, /*angle*/ 0, 90, 0,  /*behParam*/ WARP_BITS_MAIN_ENTRY          << 16, /*beh*/ bhvAirborneWarp),
        OBJECT(/*model*/ MODEL_BITS_WARP_PIPE, /*pos*/   351,  6652, -6030, /*angle*/ 0, 0, 0,   /*behParam*/ WARP_BITS_TO_BOWSER_3         << 16, /*beh*/ bhvWarpPipe),
        OBJECT(/*model*/ MODEL_NONE,           /*pos*/   351,  6800, -3900, /*angle*/ 0, 180, 0, /*behParam*/ WARP_BITS_FROM_BOWSER_3_DEATH << 16, /*beh*/ bhvDeathWarp),
        WARP_NODE(/*id*/ WARP_BITS_MAIN_ENTRY,          /*destLevel*/ LEVEL_BITS,     /*destArea*/ 0x01, /*destNode*/ WARP_BITS_MAIN_ENTRY,                 /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_BITS_TO_BOWSER_3,         /*destLevel*/ LEVEL_BOWSER_3, /*destArea*/ 0x01, /*destNode*/ WARP_BOWSER_3_MAIN_ENTRY,             /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_BITS_FROM_BOWSER_3_DEATH, /*destLevel*/ LEVEL_BITS,     /*destArea*/ 0x01, /*destNode*/ WARP_BITS_FROM_BOWSER_3_DEATH,        /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEATH,               /*destLevel*/ LEVEL_CASTLE,   /*destArea*/ 0x02, /*destNode*/ WARP_CASTLE_INSIDE_2_FROM_BITS_DEATH, /*flags*/ WARP_NO_CHECKPOINT),
        JUMP_LINK(script_func_local_1),
        JUMP_LINK(script_func_local_2),
        TERRAIN(/*terrainData*/ bits_seg7_collision_level),
        MACRO_OBJECTS(/*objList*/ bits_seg7_macro_objs),
        SET_BACKGROUND_MUSIC(/*settingsPreset*/ SEQ_SETTINGS_PRESET_DEFAULT, /*seq*/ SEQ_LEVEL_KOOPA_ROAD),
