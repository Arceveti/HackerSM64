...
const LevelScript level_bitdw_entry[] = {
    ...
    AREA(/*index*/ 1, geo_bitdw_000618),
        OBJECT(/*model*/ MODEL_NONE,            /*pos*/ -7443, -2153, 3886, /*angle*/ 0, 90, 0, /*behParam*/ WARP_BITDW_MAIN_ENTRY          << 16, /*beh*/ bhvAirborneWarp),
        OBJECT(/*model*/ MODEL_BITDW_WARP_PIPE, /*pos*/  6816,  2860,   -7, /*angle*/ 0, 0, 0,  /*behParam*/ WARP_BITDW_TO_BOWSER_1         << 16, /*beh*/ bhvWarpPipe),
        OBJECT(/*model*/ MODEL_NONE,            /*pos*/  5910,  3500,   -7, /*angle*/ 0, 90, 0, /*behParam*/ WARP_BITDW_FROM_BOWSER_1_DEATH << 16, /*beh*/ bhvDeathWarp),
        WARP_NODE(/*id*/ WARP_BITDW_MAIN_ENTRY,          /*destLevel*/ LEVEL_BITDW,    /*destArea*/ 0x01, /*destNode*/ WARP_BITDW_MAIN_ENTRY,                 /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_BITDW_TO_BOWSER_1,         /*destLevel*/ LEVEL_BOWSER_1, /*destArea*/ 0x01, /*destNode*/ WARP_BOWSER_1_MAIN_ENTRY,              /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_BITDW_FROM_BOWSER_1_DEATH, /*destLevel*/ LEVEL_BITDW,    /*destArea*/ 0x01, /*destNode*/ WARP_BITDW_FROM_BOWSER_1_DEATH,        /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEATH,                /*destLevel*/ LEVEL_CASTLE,   /*destArea*/ 0x01, /*destNode*/ WARP_CASTLE_INSIDE_1_FROM_BITDW_DEATH, /*flags*/ WARP_NO_CHECKPOINT),
