...
static const LevelScript script_func_local_1[] = {
    WARP_NODE(/*id*/ WARP_CASTLE_GROUNDS_00,                 /*destLevel*/ LEVEL_CASTLE,         /*destArea*/ 0x01, /*destNode*/ WARP_CASTLE_INSIDE_1_TO_CASTLE_GROUNDS_A, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ WARP_CASTLE_GROUNDS_01,                 /*destLevel*/ LEVEL_CASTLE,         /*destArea*/ 0x01, /*destNode*/ WARP_CASTLE_INSIDE_1_TO_CASTLE_GROUNDS_B, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ WARP_CASTLE_GROUNDS_TO_CASTLE_INSIDE_3, /*destLevel*/ LEVEL_CASTLE,         /*destArea*/ 0x03, /*destNode*/ WARP_CASTLE_INSIDE_3_TO_CASTLE_GROUNDS,   /*flags*/ WARP_NO_CHECKPOINT),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/     0,   900, -1710, /*angle*/ 0, 180, 0, /*behParam*/              WARP_CASTLE_GROUNDS_DEATH_EXIT         << 16, /*beh*/ bhvDeathWarp),
    WARP_NODE(/*id*/ WARP_CASTLE_GROUNDS_DEATH_EXIT,         /*destLevel*/ LEVEL_CASTLE_GROUNDS, /*destArea*/ 0x01, /*destNode*/ WARP_CASTLE_GROUNDS_DEATH_EXIT,           /*flags*/ WARP_NO_CHECKPOINT),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -1328,   260,  4664, /*angle*/ 0, 180, 0, /*behParam*/              WARP_CASTLE_GROUNDS_04                 << 16, /*beh*/ bhvSpinAirborneCircleWarp),
    WARP_NODE(/*id*/ WARP_CASTLE_GROUNDS_04,                 /*destLevel*/ LEVEL_CASTLE_GROUNDS, /*destArea*/ 0x01, /*destNode*/ WARP_CASTLE_GROUNDS_04,                   /*flags*/ WARP_NO_CHECKPOINT),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -3379,  -815, -2025, /*angle*/ 0,   0, 0, /*behParam*/ (60 << 24) | WARP_CASTLE_GROUNDS_TO_VCUTM           << 16, /*beh*/ bhvWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -3379,  -500, -2025, /*angle*/ 0, 180, 0, /*behParam*/              WARP_CASTLE_GROUNDS_FROM_VCUTM_DEATH   << 16, /*beh*/ bhvLaunchDeathWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -3799, -1199, -5816, /*angle*/ 0,   0, 0, /*behParam*/              WARP_CASTLE_GROUNDS_FROM_VCUTM_WARP    << 16, /*beh*/ bhvSwimmingWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -3379,  -500, -2025, /*angle*/ 0, 180, 0, /*behParam*/              WARP_CASTLE_GROUNDS_FROM_VCUTM_SUCCESS << 16, /*beh*/ bhvLaunchStarCollectWarp),
    WARP_NODE(/*id*/ WARP_CASTLE_GROUNDS_TO_VCUTM,           /*destLevel*/ LEVEL_VCUTM,          /*destArea*/ 0x01, /*destNode*/ WARP_VCUTM_MAIN_ENTRY,                    /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ WARP_CASTLE_GROUNDS_FROM_VCUTM_DEATH,   /*destLevel*/ LEVEL_CASTLE_GROUNDS, /*destArea*/ 0x01, /*destNode*/ WARP_CASTLE_GROUNDS_FROM_VCUTM_DEATH,     /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ WARP_CASTLE_GROUNDS_FROM_VCUTM_WARP,    /*destLevel*/ LEVEL_CASTLE_GROUNDS, /*destArea*/ 0x01, /*destNode*/ WARP_CASTLE_GROUNDS_FROM_VCUTM_WARP,      /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ WARP_CASTLE_GROUNDS_FROM_VCUTM_SUCCESS, /*destLevel*/ LEVEL_CASTLE_GROUNDS, /*destArea*/ 0x01, /*destNode*/ WARP_CASTLE_GROUNDS_FROM_VCUTM_SUCCESS,   /*flags*/ WARP_NO_CHECKPOINT),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  5408,  4500,  3637, /*angle*/ 0, 225, 0, /*behParam*/              WARP_CASTLE_GROUNDS_MAIN_ENTRY         << 16, /*beh*/ bhvAirborneWarp),
    WARP_NODE(/*id*/ WARP_CASTLE_GROUNDS_MAIN_ENTRY,         /*destLevel*/ LEVEL_CASTLE_GROUNDS, /*destArea*/ 0x01, /*destNode*/ WARP_CASTLE_GROUNDS_MAIN_ENTRY,           /*flags*/ WARP_NO_CHECKPOINT),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -6901,  2376, -6509, /*angle*/ 0, 230, 0, /*behParam*/              WARP_CASTLE_GROUNDS_FROM_COTMC         << 16, /*beh*/ bhvAirborneWarp),
    WARP_NODE(/*id*/ WARP_CASTLE_GROUNDS_FROM_COTMC,         /*destLevel*/ LEVEL_CASTLE_GROUNDS, /*destArea*/ 0x01, /*destNode*/ WARP_CASTLE_GROUNDS_FROM_COTMC,           /*flags*/ WARP_NO_CHECKPOINT),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  4997, -1250,  2258, /*angle*/ 0, 210, 0, /*behParam*/              WARP_CASTLE_GROUNDS_FROM_DDD_DOOR      << 16, /*beh*/ bhvSwimmingWarp),
    WARP_NODE(/*id*/ WARP_CASTLE_GROUNDS_FROM_DDD_DOOR,      /*destLevel*/ LEVEL_CASTLE_GROUNDS, /*destArea*/ 0x01, /*destNode*/ WARP_CASTLE_GROUNDS_FROM_DDD_DOOR,        /*flags*/ WARP_NO_CHECKPOINT),
    RETURN(),
};
