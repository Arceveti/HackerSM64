...
ALIGNED32 static const InsnTemplate insn_db_pseudo[] = {
    ...
    [PSEUDO_LI   ] = INSN_ID_1(OPC_ADDI   , 0, 0, 0, 0, 0      , "\'tI" , "LI"     ) // Load Immediate (pseudo of ADDI and ADDIU).
    [PSEUDO_SUBI ] = INSN_ID_1(OPC_ADDI   , 0, 0, 0, 0, 0      , "\'tsi", "SUBI"   ) // Subtract Immediate Word (pseudo of ADDI).
    ...
    [PSEUDO_DSUBI] = INSN_ID_1(OPC_DADDI  , 0, 0, 0, 0, 0      , "\'tsi", "DSUBI"  ) // Doubleword Subtract Immediate (pseudo of DADDI).
};
