...
_Bool set_and_reset_transition_fade_timer(u8 transTime) {
...
void make_tex_transition_vertices(Vtx* verts, f32 centerTransX, f32 centerTransY, f32 texTransRadius, s8 transTexType) {
 ...
 */
_Bool render_textured_transition(s8 transTime, struct WarpTransitionData* transData, s8 texID, s8 transTexType) {
...
_Bool dl_transition_color(u8 transTime, struct WarpTransitionData* transData, u8 alpha) {
...
_Bool render_fade_transition_from_color(u8 transTime, struct WarpTransitionData* transData) {
...
_Bool render_fade_transition_into_color(u8 transTime, struct WarpTransitionData* transData) {
