 ...
 */
void format_integer(s32 n, s32 base, char* dest, s32* totalLength, u8 width, _Bool zeroPad) {
    u32 powBase;
    s32 numDigits = 0;
    s32 i;
    s32 len = 0;
 ...
 * writing to 'zeroPad'.
 */
void parse_width_field(const char* str, s32* srcIndex, u8* width, _Bool* zeroPad) {
