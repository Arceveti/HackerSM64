...
ObjActionFunc sWhompActions[] = {
    [WHOMP_ACT_INIT             ] = whomp_act_init,
    [WHOMP_ACT_PATROL           ] = whomp_act_patrol,
    [WHOMP_ACT_KING_CHASE       ] = whomp_act_king_chase,
    [WHOMP_ACT_PREPARE_JUMP     ] = whomp_act_prepare_jump,
    [WHOMP_ACT_JUMP             ] = whomp_act_jump,
    [WHOMP_ACT_LAND             ] = whomp_act_land,
    [WHOMP_ACT_ON_GROUND_GENERAL] = whomp_act_on_ground_general,
    [WHOMP_ACT_TURN             ] = whomp_act_turn,
    [WHOMP_ACT_DIE              ] = whomp_act_die,
    [WHOMP_ACT_STOP_BOSS_MUSIC  ] = whomp_act_stop_boss_music,
};
