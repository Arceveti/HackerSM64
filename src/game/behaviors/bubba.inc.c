...
void bubba_act_idle(void) {
    ...
    if (o->oBubbaHitWall != OBJ_MOVE_NONE) {
        if (abs_angle_diff(o->oMoveAngleYaw, o->oBubbaTargetYaw) < 800) {
            o->oBubbaHitWall = OBJ_MOVE_NONE;
        }
    } else {
        ...
        o->oBubbaHitWall = o->oMoveFlags;

        if (o->oBubbaHitWall & OBJ_MOVE_HIT_WALL) {
...
void bubba_act_attack(void) {
    ...
    if (o->oDistanceToMario > 2500.0f) {
        ...
        if (--o->oBubbaLungeTimer == 0) {
            ...
            s16 targetPitch = 10000 - (s16)(20.0f * (find_water_level(o->oPosX, o->oPosY, o->oPosZ) - o->oPosY));
...
void bhv_bubba_loop(void) {
    ...
    if (abs_angle_diff(o->oAngleToMario, o->oMoveAngleYaw) < 0x1000
        ...
        if (o->oAnimState != BUBBA_ANIM_STATE_CLOSED_MOUTH && o->oDistanceToMario < 250.0f) {
            o->oInteractionSubtype |= INT_SUBTYPE_EATS_MARIO;
        }
