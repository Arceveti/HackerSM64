...
enum ActionArgsEndPeachCutscene { // act_end_peach_cutscene
...
enum ActionArgsIntroCutscene { // act_intro_cutscene
...
enum ActionArgsJumboStarCutscene { // act_jumbo_star_cutscene
