...
#else
static s16 sSoundMenuModeToSoundMode[2] = {
    SOUND_MODE_STEREO,
    SOUND_MODE_MONO,
};
#endif
...
void play_shell_music(void) {
    play_music(SEQ_PLAYER_LEVEL, SEQUENCE_ARGS(4, (SEQ_EVENT_POWERUP | SEQ_FLAG_VARIATION)), 0);
    sCurrentShellMusic = SEQUENCE_ARGS(4, (SEQ_EVENT_POWERUP | SEQ_FLAG_VARIATION));
}
