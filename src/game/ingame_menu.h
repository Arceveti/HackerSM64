...
void print_generic_string_centered(s16 x, s16 y, const unsigned char *str, f32 scale);
...
s32 get_str_x_pos_from_center(s16 centerPos, const unsigned char *str, f32 scale);
