...
#define GET_CELL_COORD(coord)                       get_cell_coord(coord)
#define get_surface_height_at_location(x, z, surf)  get_surface_height_at_pos((x), (z), (surf))
#define SURFACE_YAW(surf)                           get_surface_yaw(surf)
